...
var CSON, DocPad, PluginTester, RendererTester, ServerTester, assert, balUtil, chai, expect, joe, pathUtil, pluginPort, request, test, testers,
...
testers.PluginTester = PluginTester = (function() {
  ...
  function PluginTester(config, docpadConfig, next) {
    ...
    this.docpadConfig = balUtil.deepExtendPlainObjects({}, PluginTester.prototype.docpadConfig, this.docpadConfig, docpadConfig);
    ...
    joe.describe(this.config.testerName, function(suite, task, complete) {
