...
DocPad = (function(_super) {
  ...
  */
  ...
  function DocPad(instanceConfig, next) {
    ...
    balUtil.each(this.getEvents(), function(eventName) {
  ...
  DocPad.prototype.loadConfigPaths = function(configPaths, next) {
    ...
    docpad = this;
    result = {};
    if (!balUtil.isArray(configPaths)) {
      configPaths = [configPaths];
    }
    tasks = new balUtil.Group(function(err) {
      return next(err, result);
    });
    balUtil.each(configPaths, function(configPath) {
  ...
  DocPad.prototype.createCollections = function(next) {
    ...
    balUtil.each(this.config.collections, function(fn, name) {
      return tasks.push(function(complete) {
        var collection;
        if (fn.length === 2) {
  ...
  DocPad.prototype.hasPlugins = function() {
    return balUtil.isEmptyObject(this.loadedPlugins) === false;
  };
  ...
  DocPad.prototype.loadPlugins = function(next) {
    ...
    balUtil.each(this.config.pluginsPaths || [], function(pluginsPath) {
      var exists;
    ...
    balUtil.each(this.config.pluginPaths || [], function(pluginPath) {
      var exists;
  ...
  DocPad.prototype.getExchange = function(next) {
    if (!balUtil.isEmptyObject(this.exchange)) {
  ...
  DocPad.prototype.action = function(action, opts, next) {
    ...
    if (actions.length > 1) {
      ...
      balUtil.each(actions, function(action) {
        return tasks.push(function(complete) {
  ...
  DocPad.prototype.generateParse = function(opts, next) {
    ...
    this.emitSync('parseBefore', {}, function(err) {
      ...
      balUtil.each(config.documentsPaths, function(documentsPath) {
        return tasks.push(function(complete) {
      ...
      balUtil.each(config.filesPaths, function(filesPath) {
        return tasks.push(function(complete) {
      ...
      balUtil.each(config.layoutsPaths, function(layoutsPath) {
        return tasks.push(function(complete) {
          return docpad.parseDocumentDirectory({
            path: layoutsPath,
            collection: database
